...
import RomeCivitavecchia from "../assets/images/RomeCivitavecchia.png";
import ViaDeiMontiParioli from "../assets/images/ViaDeiMontiParioli.png";
  ...
  return (
    <div className="bg-white py-8 px-4 lg:px-16 flex flex-col lg:flex-row justify-between mt-[4rem] font-roboto">
      ...
      <div className="w-full lg:w-1/4 lg:pr-8 mb-8 lg:mb-0">
        <h2 className="text-[#FF8924] text-xl font-semibold mb-4">
          At a Glance
        </h2>
      ...
      <div className="w-full lg:w-3/4 flex flex-col">
        ...
        <p className="text-gray-800 mb-4 leading-relaxed">
          ...
          and architecture. The National Museum of the 21st Century Arts is a
          live example of that. The Italian cuisine has somehow managed to be a
          king of all cuisines, from the Carciofi alla Romana to the Spaghetti
          alla Carbonara - Delicious spaghetti topped with bacon, smokey eggs,
          and pecorino is what makes it mouth-watering.
        </p>
